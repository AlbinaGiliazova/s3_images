"""
Django settings for avatars project.
...
class EnvSettings(BaseSettings):
    secret_key: SecretStr | None = get_random_secret_key()
    db_host: str | None = '127.0.0.1'
    db_user: str | None = 'my_user'
    db_pass: SecretStr | None = get_random_secret_key()
...
AWS_S3_USE_SSL = env_settings.aws_s3_use_ssl
...
WSGI_APPLICATION = 'avatars.wsgi.application'
...
AUTH_USER_MODEL = 's3_avatars.CustomUser'
